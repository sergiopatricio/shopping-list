...
user.items.create!(group: group1, temporary: true, position: 1, name: 'Temp M', total: 1, confirmed: true)
user.items.create!(group: group1, temporary: true, position: 2, name: 'Temp C')
...
user.items.create!(group: group2, temporary: true, position: 1, name: 'Temp I', total: 2)
